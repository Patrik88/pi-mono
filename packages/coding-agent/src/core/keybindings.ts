...
export const KEYBINDINGS = {
	...
	"app.tools.expand": { defaultKeys: "ctrl+o", description: "Cycle tool result display mode" },
	"app.tools.calls.toggle": { defaultKeys: "shift+ctrl+o", description: "Toggle tool call detail" },
	"app.thinking.toggle": {
		defaultKeys: "ctrl+t",
